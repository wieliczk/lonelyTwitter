...
public abstract class Tweet {
    ...
    public void addThumbnail(Bitmap newThumbnail) {
        if (newThumbnail != null) {
            ...
            ByteArrayOutputStream byteArrrayBitmapStream = new ByteArrayOutputStream();
            newThumbnail.compress(Bitmap.CompressFormat.PNG, 100, byteArrrayBitmapStream);
            byte[] b = byteArrrayBitmapStream.toByteArray();
